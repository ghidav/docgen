...
import { Plus, PanelLeftClose, List } from "lucide-react";
...
export const DocumentEditor = forwardRef<
  DocumentEditorRef,
  DocumentEditorProps
>(function DocumentEditor({ initialDocument, onBack, onStateChange }, ref) {
  ...
  }, [saving, refetching, document.id, onStateChange]);
  ...
  const handleRefetch = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          err instanceof Error ? err.message : "Failed to refetch document",
        variant: "destructive",
      });
    } finally {
      setRefetching(false);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        {tocVisible && (
          <aside className="w-64 border-r border-border bg-muted/30 sticky top-0 h-screen overflow-y-auto">
            <DocumentToc
              document={document}
          ...
          <div className="max-w-4xl mx-auto px-16 py-12">
            ...
            <div className="mb-16">
              ...
              <Input
                ...
                className="text-lg text-muted-foreground border-0 p-0 h-auto focus-visible:ring-0 focus-visible:ring-offset-0 bg-transparent placeholder:text-muted-foreground/30"
              />
            </div>
